...
const TermsofUse = () => {
  return (
    <div className='max-w-4xl mx-auto px-4 py-6 ibm-plex-mono-regular leading-4'>
     <div>
...
<div>
  <h2 className="text-2xl font-semibold mb-4">1. Grievance Officer Information (Compliance with IT Rules 2021)</h2>
  <p className="mb-4">
...
<div>
  <h2 className="text-2xl font-semibold mb-4">3. Our Platform Features</h2>
  <p className="mb-4">
  ...
  <ul className="list-disc pl-5">
    <li>
      <span className="font-semibold">Profile Creation and Maintenance: </span>
      Set up and customize your profile after registration.
    </li>
    <li>
      <span className="font-semibold">Poll Participation: </span>
      Engage in friendly polls with your friends or acquaintances.
    </li>
    <li>
      <span className="font-semibold">Content Sharing: </span>
      Post your own content, re-post content from others, and connect with other users, either anonymously or otherwise.
    </li>
    <li>
      <span className="font-semibold">Content Management: </span>
      Post content with or without identifying information, and edit or remove contents as needed.
    </li>
    <li>
      <span className="font-semibold">Compliments and Connections: </span>
      Send and receive compliments, responses, or information from friends, acquaintances, or even unknown users, who may choose to reveal or conceal their identities.
    </li>
    <li>
      <span className="font-semibold">Premium Features: </span>
      From time to time, we may offer paid features, such as notifications about the identity of users who sent you compliments.
    </li>
  </ul>
  <p className="my-4">
...
<div>
  <h2 className="text-2xl font-semibold mb-4">7. GETTING SUPPORT</h2>
  <p className='mb-4'>
    Need help? Svipes offers in-app and email support. Just shoot us an email at 
    <a href="mailto:support@svipes.com" className="underline text-blue-600"> support@svipes.com</a>.
  </p>
  <p className='mb-4'>
  ...
  <p className='mb-4'>
    If you need to report content, use our in-app tools or email us directly at
    <a href="mailto:support@svipes.com" className="underline text-blue-600"> support@svipes.com</a>.
  </p>
</div>

<div>
  <h2 className="text-2xl font-semibold mb-4">8. USER LICENSE AGREEMENT</h2>
  <p className='mb-4'>
...
<div>
  <h2 className="text-2xl font-semibold mb-4">9. PROHIBITIONS ON ACCESS</h2>
  <p className='mb-4'>
  ...
  <ul className="list-disc pl-5 my-4">
    <li>Access or use the Services if You are not fully able and legally competent to agree to this TOS, unless your Parents consent in terms of this TOS.</li>
    <li>Modify, adapt, translate, reverse engineer, disassemble, decompile, or create any derivative works based on the Services, including any files, tables, or documentation (or any portion thereof) or determine or attempt to determine any source code, algorithms, methods, or techniques embodied in the Platform or any derivative works thereof.</li>
    <li>Distribute, license, transfer, or sell, in whole or in part, any of the Services or any derivative works thereof, including any data obtained from the Platform.</li>
    <li>Market, rent, or lease the Services for a fee or charge, or use the Platform to advertise or perform any commercial solicitation.</li>
    <li>Interfere with or attempt to interfere with the proper working of the Services, disrupt our website or any networks connected to the Services, or bypass any measures we may use to prevent or restrict access to the Services.</li>
    <li>Incorporate the Platform or any portion thereof into any other program or product. In such cases, we reserve the right to refuse service, terminate accounts, or limit access to the Services at our sole discretion.</li>
    <li>Use automated scripts to collect information from or otherwise interact with the Services.</li>
    <li>Impersonate any person or entity, or falsely state or otherwise misrepresent yourself or your affiliation with any person or entity, including giving the impression that any content you upload, post, transmit, distribute, or otherwise make available emanates from the Services.</li>
    ...
    <li>Use or attempt to use another&apos;s account, service, or system without authorization from Us, or create a false identity on the Services.</li>
    <li>Use the Services in a manner that may create a conflict of interest or undermine the purposes of the Services.</li>
    <li>Use the Services to upload, transmit, distribute, store, or otherwise make available in any way (including for the purposes of creating and/or streaming content):</li>
    <div>
      <ul className="list-disc pl-10 my-4">
        ...
        <li>Any unsolicited or unauthorized advertising, solicitations, promotional materials, &quot;junk mail,&quot; &quot;spam,&quot; &quot;chain letters,&quot; &quot;pyramid schemes,&quot; or any other prohibited form of solicitation.</li>
        <li>Any private information of any third party, including addresses, phone numbers, email addresses, numbers, and features in personal identity documents (e.g., Aadhaar, License Number, Passport, Bank account) or credit card numbers.</li>
        <li>Any content which does or may infringe any copyright, trademark, or other intellectual property or privacy rights of any other person.</li>
        <li>Any content which is defamatory of any person, obscene, offensive, hateful, or inflammatory.</li>
        <li>Any content that would constitute, encourage, or provide instructions for a criminal offense, dangerous activities, or self-harm.</li>
        <li>Any content that is deliberately designed to provoke or antagonize people, especially trolling, or is intended to harass, scare, distress, embarrass, or upset people.</li>
        <li>Any content that contains a threat of any kind, including threats of physical violence.</li>
        <li>Any content that is racist or discriminatory, including discrimination on the basis of someone&apos;s race, religion, age, gender, disability, or sexuality.</li>
        ...
        <li>Use any automated systems or software to withdraw data from the Platform.</li>
        <li>Content that, in our sole judgment, is objectionable or which restricts or inhibits any other person from using the Services, or which may expose Us, the Services, or its users to any harm or liability of any type.</li>
      </ul>
    </div>
    <li>Violate any law, regulation, contract, intellectual property, or other third-party right, or commit a tort while using the Services.</li>
...
<div>
  <h2 className="text-2xl font-semibold mb-4">10. PLATFORM PAYMENTS</h2>
  <p className='mb-4'>
...
<div>
  <h2 className="text-2xl font-semibold mb-4">12. COMPLIANCE WITH APPLICABLE LAW</h2>
  <p className="mb-4">
...
<div>
  <h2 className="text-2xl font-semibold mb-4">14. MODIFICATION, SUSPENSION, &amp; TERMINATION OF ACCOUNT OR SERVICES</h2>
  <p className="mb-4">
...
<div>
  <h2 className="text-2xl font-semibold mb-4">15. PROPRIETARY RIGHTS</h2>
  <p className="mb-4">
...
<div>
  <h2 className="text-2xl font-semibold mb-4">16. THIRD-PARTY CONTENT</h2>
  <p className="mb-4">
...
<div>
  <h2 className="text-2xl font-semibold mb-4">17. DISCLAIMER OF WARRANTIES BY COMPANY</h2>
  <p className="mb-4">
...
<div>
  <h2 className="text-2xl font-semibold mb-4">18. INDEMNIFICATION</h2>
  <p className="mb-4">
...
<div>
  <h2 className="text-2xl font-semibold mb-4">19. LIMITATION OF LIABILITY</h2>
  <p className="mb-4">
  ...
  <ul className="list-disc pl-5 my-4">
    ...
    <li>FOR ANY DIRECT DAMAGES IN EXCESS (IN THE AGGREGATE) OF INR 5,000/- (in the case of India) and USD 150 (in the case of countries other than India);</li>
    <li>FOR ANY MATTER BEYOND ITS OR THEIR REASONABLE CONTROL, EVEN IF SVIPES HAS BEEN ADVISED OF THE POSSIBILITY OF ANY OF THE AFOREMENTIONED DAMAGES.</li>
  </ul>
</div>

<div>
  <h2 className="text-2xl font-semibold mb-4">20. BREACH OF TERMS</h2>
  <p className="mb-4">
  ...
  <ul className="list-disc pl-5 my-4">
    <li>Send one or more formal warnings to you, if the breach can be remedied or corrected by you;</li>
    <li>Temporarily suspend your access to our Platform and suspend your User Account;</li>
    <li>Permanently prohibit you from accessing our Platform and our Services;</li>
    <li>Block computers using your IP address or contact any or all of your internet service providers and request that they block your access to our Platform; and/or</li>
    <li>Commence legal action against you, whether for contractual breach or otherwise.</li>
  </ul>
</div>
...
<div>
  <h2 className="text-2xl font-semibold mb-4">22. OTHER TERMS</h2>
  <ul className="list-disc pl-5 my-4">
    <li>
      <span className="font-semibold">Remedies: </span> 
      If you violate any of this TOS, we may, as we determine reasonably necessary to remedy or mitigate your violation, delete all or part of such information transmitted by you, suspend or cancel your User Account. We shall in no event be responsible or liable for any damage incurred by the user as a result of an action taken by us pursuant to this paragraph. Any right or remedy of Svipes set forth in this TOS is in addition to, and not in lieu of, any other right or remedy, whether described in this TOS, under statute, at law, or in equity.
    </li>

    <li>
      <span className="font-semibold">Non-waiver: </span>
      Our failure or delay in exercising any right, power, or privilege under this TOS shall not operate as a waiver thereof.
    </li>
    <li>
      <span className="font-semibold">Severability: </span> 
      The invalidity or unenforceability of any of this TOS shall not affect the validity or enforceability of any other part of this TOS, all of which shall remain in full force and effect.
    </li> 
    <li>
      <span className="font-semibold">Force Majeure: </span> 
      We will have no responsibility or liability for any failure or delay in the performance of any Services, or any loss or damage that you may incur, due to any circumstance or event beyond our control, including without limitation any flood, extraordinary weather conditions, earthquake, or other act of God, fire, war, insurrection, riot, labor dispute, accident, action of government, communications, power failure, or equipment or software malfunction.
    </li>
   
    
  <li>
    <span className="font-semibold">Competitor: </span>
    No employee, independent contractor, agent, or affiliate of any competing social media company is permitted to view, access, or use any portion of the Service without express written permission from Svipes. By viewing, using, or accessing the Service, you represent and warrant that you are not a competitor of Svipes or any of its affiliates, or acting on behalf of a competitor of Svipes in using or accessing the Service.
  </li>
  <li>
    An Account cannot be sold or transferred. You are prohibited from buying, selling, or exchanging accounts for cash or kind or any other value or for no value. You may not assign or transfer any right to use the Services or any of your rights or obligations under this TOS without prior written consent from us, including by operation of law. We may assign or transfer any or all of its rights or obligations under this TOS, in whole or in part, without notice or obtaining your consent or approval.
  </li>
  <li>
    <span className="font-semibold">Entire Agreement: </span>
    This TOS contains the entire agreement and supersedes all prior and contemporaneous understandings between the parties regarding the Services on the Platform. In the event of any conflict between this TOS and any other agreement you may have with us, this TOS will control unless the other agreement specifically identifies this TOS and declares that the other agreement supersedes this TOS.
  </li>
</ul>

<p className='mb-4'>
  For any grievances or support requests, please contact us at
  <a href="mailto:support@svipes.com" className="underline text-blue-600"> support@svipes.com</a>.
</p>
