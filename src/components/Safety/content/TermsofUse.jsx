...
const TermsofUse = () => {
  return (
    <div className='max-w-4xl mx-auto px-4 py-6 ibm-plex-mono-regular leading-5'>
     <div>
...
<div>
  <h2 className="text-2xl font-semibold mb-2">Grievance Officer Information (Compliance with IT Rules 2021)</h2>
  <p className="mb-2">
...
<div>
  <h2 className="text-2xl font-semibold mb-2">Our Platform Features</h2>
  <p className="mb-2">
...
<div>
  <h2 className="text-2xl font-semibold mb-2">GETTING SUPPORT</h2>
  <p className='mb-2'>
...
<div>
  <h2 className="text-2xl font-semibold mb-2">USER LICENSE AGREEMENT</h2>
  <p className='mb-2'>
...
<div>
  <h2 className="text-2xl font-semibold mb-2">PROHIBITIONS ON ACCESS</h2>
  <p className='mb-2'>
...
<div>
  <h2 className="text-2xl font-semibold mb-2">PLATFORM PAYMENTS</h2>
  <p className='mb-2'>
...
<div>
  <h2 className="text-2xl font-semibold mb-2">COMPLIANCE WITH APPLICABLE LAW</h2>
  <p className="mb-2">
...
<div>
  <h2 className="text-2xl font-semibold mb-2">MODIFICATION, SUSPENSION, &amp; TERMINATION OF ACCOUNT OR SERVICES</h2>
  <p className="mb-2">
...
<div>
  <h2 className="text-2xl font-semibold mb-2">PROPRIETARY RIGHTS</h2>
  <p className="mb-2">
...
<div>
  <h2 className="text-2xl font-semibold mb-2">DISCLAIMER OF WARRANTIES BY COMPANY</h2>
  <p className="mb-2">
...
<div>
  <h2 className="text-2xl font-semibold mb-2">BREACH OF TERMS</h2>
  <p className="mb-2">
...
<div>
  <h2 className="text-2xl font-semibold mb-2">OTHER TERMS</h2>
  <ul className="list-disc pl-5 my-4">
    <li>
